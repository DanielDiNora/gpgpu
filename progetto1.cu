								...
								float* __restrict__ d_vec1,float* __restrict__ d_vec2)
{
	...
	if(i<(r_res*c_res)){
		...
		res_vec[i+1]=d_vec1[c1]*d_vec2[j1];

		res_vec[i+2]=d_vec1[c2]*d_vec2[j2];

		res_vec[i+3]=d_vec1[c3]*d_vec2[j3];
	}
}
...
void vecsum(int nels, float* __restrict__ res_vec, float* __restrict__ d_vec1, float* __restrict__ d_vec2)
{
	...
	res_vec[i+1] =d_vec1[i+1]+d_vec2[i+1];
	res_vec[i+2] =d_vec1[i+2]+d_vec2[i+2];
	res_vec[i+3] =d_vec1[i+3]+d_vec2[i+3];
